...
export default function FeaturesSection() {
  ...
  return (
    <div className="max-w-[1250px] m-auto h-fit flex flex-col items-center py-16">
      <Image
        loading="lazy"
        width={180}
        height={80}
      ...
      <p className="max-w-[680px] text-base font-normal leading-[24px] text-center mb-6">
      ...
      <div className="w-full flex justify-end my-4">
        <p className=" text-[12px] font-light leading-[47px] tracking-[0.03em] text-[#686868]">
      ...
      <div className="w-full h-[494px] relative my-5">
